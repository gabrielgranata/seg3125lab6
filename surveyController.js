...
module.exports = function(app) {
    ...
    app.get('/analysis', function(req, res) {
        ...
        var movie = readData("movie");
        var soda = readData("soda");
        var sport = readData("sport");
        res.render('showResults', { results: [color, fruit, animal, movie, soda, sport] });
        console.log([color, fruit, animal, movie, soda, sport]);
    });
    ...
    app.post('/niceSurvey', urlencodedParser, function(req, res) {
        ...
        for (var key in json) {
            ...
            if (((key === "color") || (key == "soda")) && (json[key].length === 2)) {
